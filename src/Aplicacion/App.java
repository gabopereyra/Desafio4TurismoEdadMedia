...
public class App {
	...
	public static List<Usuario> creacionUsuario() {
		...
		Usuario Sam = new Usuario(36d, 8d, "Degustacion");
	...
	public static List<Atraccion> creacionAtraccion() {
		...
		Atraccion LaComarca = new Atraccion("La Comarca", 3.0, 6.5, 150, "Degustacion");
		...
		Atraccion Lothlorien = new Atraccion("Lothlorien", 35.0, 1.0, 30, "Degustacion");
